...
[![Build Status](https://ci.vironlab.eu/job/Vextension/badge/icon)](https://ci.vironlab.eu/job/DiscordCommands/)

### Project description

A Simple CommandSystem for the DiscordAPI Wrapper: JDA
